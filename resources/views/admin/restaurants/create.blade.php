        ...
        <form class="row g-3" action="{{ route('admin.restaurants.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" required
                    name="name" maxlength="255" minlength="3" value="{{ old('name') }}">
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control @error('vat_number') is-invalid @enderror" id="vat_number"
                    name="vat_number" maxlength="11" minlength="11" required value="{{ old('vat_number') }}">
                @error('vat_number')
            ...
            <div class="col-6">
                ...
                <input type="text" class="form-control @error('address') is-invalid @enderror" id="address"
                    name="address" value="{{ old('address') }}" maxlength="255" minlength="3" required>
                @error('address')
                    <span class="text-danger">{{ $message }}</span>
                @enderror
            ...
            <div class="form-group">
                ...
                @endforeach
                <div id="typeHelp" class="form-text mt-2">Seleziona almeno un tipo</div>
                @error('types')
                    <span class="text-danger">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="col-12">
                ...
                <textarea maxlength="255" minlength="3" class="form-control @error('description') is-invalid @enderror"
            ...
            <div class="mb-3 col-6  my-3 mt-3">
                ...
                @if (old('logo'))
                    <div class="container-img">
                        <img src="{{ asset('storage/' . old('logo')) }}" alt="{{ old('logo') }}"
                            id="uploadPreviewLogo" class="shadow rounded-4 m-4">
                    </div>
                @else
                    <div class="container-img">
                        <img src="https://img.freepik.com/free-vector/illustration-gallery-icon_53876-27002.jpg"
