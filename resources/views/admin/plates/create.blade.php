        ...
        <form class="row g-3 mt-3" action="{{ route('admin.plates.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="col-6">
                ...
                <input type="number" class="form-control @error('price') is-invalid @enderror" id="price"
                    name="price" value="{{ old('price') }}" step="0.01" maxlength="6" minlength="0.01" min="0.01"
                    required>
                @error('price')
                    <span class="text-danger">{{ $message }}</span>
                @enderror
                ...
                <div>
                    ...
                    <div class="form-check">
                        <input class="form-check-input custom-checkbox" type="checkbox" name="visibility" id="visibility"
                            value="1" {{ old('visibility') ? 'checked' : '' }} checked>
            ...
            <div class="col-12 mb-5">
                <button type="submit" class="container-btn-file">Salva</button>
            </div>
